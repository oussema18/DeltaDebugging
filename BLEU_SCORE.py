...
if __name__ == "__main__":
    ...
    with open(jsonl_file_path, "r") as file:
        ...
        for i in range(1):
            ...
            print("======================= BLUE SCORE ========================")
            print(
                "between Commments and Reduced code : ",
                calculate_BLEU_score_strings(summary, program),
            )
            print(
                "between Prediction and Comments :",
                calculate_BLEU_score_strings(predict, summary),
            )
            print("-----------------------------------------------------------")
