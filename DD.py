...
class DD:
    ...
    def test_and_resolve(self, csub, r, c, direction):
        ...
        # c2 [(0, 'for'), (1, ' '), (2, 'i'), (3, ' '), (4, '<'), (5, 'mask'), (6, '>'), (7, ' '), (8, ' '), (9, 'j'), (10, ' '), (11, ':'), (12, ' '), (13, 'print'), ...]
        # c [(0, 'for'), (1, ' '), (2, 'i'), (3, ' '), (4, '<'), (5, 'mask'), (6, '>'), (7, ' '), (8, ' '), (9, 'j'), (10, ' '), (11, ':'), (12, ' '), (13, 'print'), ...]
        # csub [(0, 'for'), (1, ' '), (2, 'i'), (3, ' '), (4, '<'), (5, 'mask'), (6, '>'), (7, ' ')]
        # csubr [(0, 'for'), (1, ' '), (2, 'i'), (3, ' '), (4, '<'), (5, 'mask'), (6, '>'), (7, ' ')]
...
if __name__ == "__main__":
    ...
    class MyDD(DD):
        ...
        def _test_c(self, c):
            if 1 in c and 2 in c and 3 in c and 4 in c and 6 in c and 8 in c:
                if 5 in c and 7 in c:
                    return self.UNRESOLVED
                else:
                    return self.FAIL
            if 1 in c or 2 in c or 3 in c or 4 in c or 6 in c or 8 in c:
                return self.UNRESOLVED
            return self.PASS
